  ...
  return (
    <section  className="py-10 w-[90%] mx-auto">
      ...
      <section className="grid grid-cols-3 items-center border-b  border-gray-300 py-3">
        ...
        <input type="number"  id="min_nights" className=" border border-gray-300 rounded-md px-3 py-2" value={5}  />
      </section>
      <section className="grid grid-cols-3 items-center border-b  border-gray-300 py-3">
        <label htmlFor="max_nights" className=" font-medium">Maximum nights/booking</label>
        <input type="number"  id="max_nights" className=" border border-gray-300 rounded-md px-3 py-2" value={5}  />
      </section>
      <section className="grid grid-cols-3 items-center border-b  border-gray-300 py-3">
